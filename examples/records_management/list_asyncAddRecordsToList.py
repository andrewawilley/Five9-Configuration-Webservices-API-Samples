...
list_update_settings = {
    "fieldsMapping": [
        ...
        {"columnNumber": 1, "fieldName": "state", "key": "true"},
    ...
    "crmAddMode": "ADD_NEW",
    "crmUpdateMode": "UPDATE_ALL",  # CAUTION - ensure proper record key values are set
    "listAddMode": "ADD_ALL",  # if multiple contactDB records are matched, determine if multiple list entries should be added.
}
